...
class _AcceptTaskState extends State<AcceptTask> {
  ...
  getTaskPending() {
    context.read<TaskListCubit>().init(status: 'Awaiting');
  }
                                  ...
                                  return MultiBlocProvider(
                                    ...
                                    child: Builder(builder: (context) {
                                      return AlertDialog(
                                        ...
                                        content: Text(
                                            'Are you sure you want to mark this task as Accept?'),
                                        actions: [
                                          TextButton(
                                            onPressed: () {
                                              // Close the dialog
